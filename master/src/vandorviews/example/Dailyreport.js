...
const saveaction = () => {
    ...
    if( hour ==true && day== true ) {
        alert("please selcet single or team")
    }else{
    axios.post(`http://localhost:3001/daily`,data)
    .then(res => {
        console.log(res);
        console.log(res.data.data);
    ...
    return (
        <>
            ...
            <div className="containers">
                <div > <h3 style={{ textAlign: 'center',fontStyle:'italic'}}>Vendor Daily work Report</h3></div>
                <div className="main">
                    <h1 style={{ textAlign: 'center',fontStyle:'italic'}}>Daily work Report </h1>
                    <Form className="form">
                        ...
                        <Form.Label style={{fontStyle:'oblique',fontWeight: 'bold'}}>Daily Reports</Form.Label>
                        <div className="mb-3" style={{ marginTop:'10px',fontStyle:'italic' }}>
 ...
 */}
 ...
 <Form.Group controlId="formBasicEmail">
                            <label style style={{fontStyle:'oblique',fontWeight: 'bold'}} >
                                <input type="checkbox"
                            ...
                            <Form.Group controlId="exampleForm.SelectCustom">
                                ...
                                <Form.Control type="text" placeholder="total hour"  onChange={(event) => { setHourwork(event.target.value) }}  />
                                <Form.Control type="text" placeholder="Timing"  onChange={(event) => { setTimingwork(event.target.value) }}  />
                            </Form.Group>
                        </Form.Group>
: null}
...
: null}
                        ...
                        <Button variant="dark" type="button" style ={{marginLeft:'300px'}} className="submit" onClick={saveaction} >
                            Submit
</Button>
                    </Form>
                </div>
