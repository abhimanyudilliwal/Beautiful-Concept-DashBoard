...
const saveaction = () => {
    ...
    axios.post(`http://localhost:3001/payhour`,data)
    .then(res => {
        console.log(res);
        console.log(res.data.data);
    ...
    return (
        <>
            ...
            <div className="containers">
                <div > <h3 style={{ textAlign: 'center',fontStyle:'italic'}}>PAY AS HOURLY</h3></div>
                <div className="main">
                    <h1 style={{textAlign: 'center',fontStyle:'italic' }}>HOURUL</h1>
                    <Form className="form">
 ...
 */}
 ...
 <Form.Group controlId="formBasicEmail">
                            ...
                            <Form.Group controlId="exampleForm.SelectCustom">
                                ...
                                <Form.Control type="time" placeholder="Timing"  onChange={(event) => { setTimingwork(event.target.value) }}  />
                            </Form.Group>
                        </Form.Group>
: null}
